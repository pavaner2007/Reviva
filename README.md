...
**Phase:** Phase 1 — Foundation & Synthetic Data

---

## What Phase 1 Implements

Phase 1 lays the technical foundation for the full recovery pipeline. It does **not** include AI, recovery logic, or a frontend.
...
| **Synthetic data** | Exactly 50 realistic failed-payment records |
| **Razorpay health check** | Test-mode credential verification via SDK |
